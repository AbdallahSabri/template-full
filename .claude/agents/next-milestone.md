---
description: Implement the next unchecked milestone from SPEC.md, gate it, and commit.
---
...
milestone calls for, per CLAUDE.md's "Documentation maintenance" section.
...
2. `git add -A && git commit -m "feat(m<N>): <milestone name>"` with the
   gate criteria pasted into the commit body.
